...
import com.github.controller.MainMenuController;
...
public class PaneWidthMinusButton extends Button implements ButtonInterface {

    private String buttonName = "paneWidthMinusButton";

    private final MainMenuHandler handler;

    public PaneWidthMinusButton(MainMenuHandler handler) {
    ...
    private void initActions() {
        ...
        this.setOnMouseClicked(event -> {
            this.handler.handleAction(getButtonName(), event);
        });
    }
