...
public class MinesQuantityInputBox extends TextField implements InputBox<String> {

    public MinesQuantityInputBox() {
        init();
    }

    private void init() {
        this.setId("main_panel_bombs_quantity_text_box");
